...
#define FLAGS_ISZERO (state.f & FLAGS_ZERO)
#define FLAGS_ISNEGATIVE (state.f & FLAGS_NEGATIVE)
#define FLAGS_ISCARRY (state.f & FLAGS_CARRY)
#define FLAGS_ISHALFCARRY (state.f & FLAGS_HALFCARRY)

#define FLAGS_ISSET(x) (state.f & (x))
#define FLAGS_SET(x) (state.f |= (x))
#define FLAGS_CLEAR(x) (state.f &= ~(x))
